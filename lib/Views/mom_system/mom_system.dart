...
import 'package:cartoon_app/Views/working_system/working_system.dart';
import 'package:flutter/material.dart';
import '../car_screen/car_screen.dart';
import '../stairs_screen/stairs_screen.dart';


class MomSystemScreen extends StatefulWidget {
  const MomSystemScreen({super.key});

  @override
  State<MomSystemScreen> createState() => _MomSystemScreenState();
}

class _MomSystemScreenState extends State<MomSystemScreen> {
  @override
  void initState() {
    super.initState();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(image: AssetImage('assets/Images/cover_images/cover_4.png'), fit: BoxFit.fill)
                      ),
                    ),
